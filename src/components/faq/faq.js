...
export const Faq = () => {
  ...
  return (
    <section className="faq">
        ...
        <button onClick={() => {change(1);}} className='fBtn faqButton1 active' id='faqButton1'><span><h4 className="faqh4">1. That is special about comparing rental car deals? </h4></span>
